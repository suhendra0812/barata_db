...
# db_path = os.path.join(base_dir, 'barata_db.db')
...
csk_dirs = glob.glob("E:/BARATA/seonse_outputs/cosmo_skymed/*/*")
rs_dirs = glob.glob("E:/BARATA/seonse_outputs/radarsat/*/*")
...
for i, data_dir in enumerate(data_dirs):
    ...
    scene_list = glob.glob(os.path.join(data_dir, "*.tif"))
    if len(scene_list) > 0:
        # print("Insert scene...")
